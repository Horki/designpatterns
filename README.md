...
| [Proxy](https://en.wikipedia.org/wiki/Proxy_pattern) | *The Proxy Pattern* provides a surrogate or placeholder for another object to control access to it. | 11 | RMI Proxy Gumball [server](src/Structural/Proxy/Gumball/GumballProxyServerMain.java) [client](src/Structural/Proxy/Gumball/GumballProxyClientMain.java) |
