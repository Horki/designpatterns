...
| [Proxy](https://en.wikipedia.org/wiki/Proxy_pattern) | *The Proxy Pattern* provides a surrogate or placeholder for another object to control access to it. | 11 | [Proxy Gumball](src/Structural/Proxy/Gumball/GumballProxyMain.java) |
